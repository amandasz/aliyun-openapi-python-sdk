...
class TestAccessKeySigner(unittest.TestCase):
    def test_accesskey_signer(self):
      ...
      #self.assertEqual(url, '/?SignatureVersion=1.0&Format=None&Timestamp=2018-12-02T11%3A03%3A01Z&RegionId=cn-hangzhou&AccessKeyId=access_key_id&SignatureMethod=HMAC-SHA1&Version=version&Signature=AmdeJh1ZOW6PgwM3%2BROhEnbKII4%3D&Action=action_name&SignatureNonce=d5e6e832-7f95-4f26-9e28-017f735721f8&SignatureType=')